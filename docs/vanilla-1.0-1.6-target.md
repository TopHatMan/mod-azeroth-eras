# Ready target: Vanilla 1.0–1.6

Status: current playable target

Launch is **1.0** (`Progression.Patch = 0`). Blizzard’s retail client called that build 1.1.0. There is no extra public 1.1 content step in this ladder.
...
|---:|:---:|---|---|
| 0 | 1.0 Launch | MC and Onyxia via BRD / launch attunement. Maraudon and later raids closed. Lothos hidden. Outland/Northrend closed. | `patch_00` SQL + runtime map gates |
...
`.progression info` should print `0 (1.0 World of Warcraft)` and `Ready target: 1.0-1.6 (IDs 0-5)`.
