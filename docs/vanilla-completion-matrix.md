...
| World events | Holidays, elemental invasions, AQ war effort/gates, Scourge Invasion, and patch events | AQ scripts exist; Scourge event 17 gate and lifecycle contract implemented, runtime pending | Event state, quests, spawns, loot, and reset behavior transition together |
