...
{
    // Retail launch was patch 1.1.0. Keep ID 0 stable while presenting the
    // historical patch correctly as 1.1.
    PATCH_VANILLA_1_1 = 0,
    PATCH_WORLD_OF_WARCRAFT = PATCH_VANILLA_1_1,
...
constexpr uint8 DEFAULT_PROGRESSION_PATCH = PATCH_VANILLA_1_1;
constexpr uint8 DEFAULT_PROGRESSION_LEVEL_CAP = 60;
// Headline gates for 1.1-1.6 are the current playable target. Later Vanilla
